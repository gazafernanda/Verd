...
<template>
  <!-- Single RouterView: render auth pages full-screen or app layout depending on route meta -->
  <RouterView v-slot="{ Component }">
    <template v-if="route.meta && route.meta.hideLayout">
          ...
          <div class="lg:hidden flex items-center gap-3 mb-6">
            ...
            <div class="flex items-center gap-2">
              ...
              >
                <path
                  fill="#1a5641"
                  d="M226.79,150.29A103.49,103.49,0,0,0,144,32H96a8,8,0,0,0-8,8v48a103.49,103.49,0,0,0,82.79,118.29,8,8,0,0,0,9.65-9.65A55.85,55.85,0,0,1,168,152a56,56,0,0,1,56.76-55.93,8,8,0,0,0,7.9-9.65,103.11,103.11,0,0,0-5.87-36.13Z"
                />
              </svg>
            ...
            <div class="flex items-center gap-2.5">
              <span class="text-[0.9rem] font-semibold text-text-main">{{
                user.displayName
              }}</span>
              <div
                class="w-8 h-8 rounded-full bg-gradient-to-br from-[#f08b5e] to-[#e85d46] shadow-sm shrink-0"
              ></div>
            </div>
          </div>
